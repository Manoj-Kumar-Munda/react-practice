...
const Shimmer = () => {
  return (
    // <div className="overflow-hidden relative max-w-xs w-full  flex-col space-y-2">
    //   <div className="overflow-hidden relative w-full h-40 bg-[#cfd1d2]">
    //     <div className="skeleton"></div>
    //   </div>

    //   <div className="overflow-hidden relative w-full h-5 bg-[#cfd1d2] skeleton">
    //     <div className="skeleton"></div>
    //   </div>

    //   <div className="overflow-hidden relative w-4/5 h-5 bg-[#cfd1d2] skeleton">
    //     <div className="skeleton"></div>
    //   </div>

    //   <div className="overflow-hidden relative w-1/2 h-5 bg-[#cfd1d2] skeleton">
    //     <div className="skeleton"></div>
    //   </div>
    // </div>
